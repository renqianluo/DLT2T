  ...
  * PREDICT: Constructs the predictions
  ...
  def nth_model(n):
    ...
    with tf.variable_scope("losses_avg"):
      ...
      lm_decay = 1.0
      trade_off = 0.5
      total_loss = total_loss_DL_A2B + total_loss_DL_B2A + trade_off * (lm_decay * lm_score_A + total_loss_DSL_A2B - lm_decay * lm_score_B - total_loss_DSL_B2A)**2
